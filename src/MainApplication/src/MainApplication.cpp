...
MainApplication::MainApplication(QWidget* parent) : QMainWindow(parent), mButtonPressedAmt(0)
{
    ...
    QObject::connect(this, &MainApplication::sigLabelTextUpdated, this, [](std::string_view val){
        std::cout << val << std::endl;
    });
}

void MainApplication::updateLabelText()
{
